...
"""
Конечно можно было решить эту задачу создав родительский класс ЛампочкаСветофора и унаследовав от него
дочерние классы КраснаяЛампочка ЖелтаяЛампочка и ЗеленаяЛампочка, но в любом случае пришлось-бы прописывать
последовательность их переключения где-то "снаружи", т.к. у желтой лампочки есть два возможных направления
переключения (Кр или Зел). 
Поэтому сделал через список словарей/состояний - так значительно проще и главное - короче раз в 5.
"""
